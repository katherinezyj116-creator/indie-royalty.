...
export default function LoginPage() {
  ...
  return (
    <PageShell title="Log back in" subtitle="Access your splits, fan perks, and wallet tools.">
      ...
      <p className="text-sm text-slate-600">
        Need an account?{" "}
        <Link href="/signup" className="text-pink-500 underline-offset-4 hover:underline">
          Create one
        </Link>
      </p>
    </PageShell>
